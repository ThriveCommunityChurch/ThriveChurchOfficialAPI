...
namespace ThriveChurchOfficialAPI.Core
{
    public class SermonMessageRequest
    {
        ...
        public static ValidationResponse ValidateRequest(SermonMessageRequest request)
        {
            ...
            // Note: WaveformData is no longer required - it's generated by the sermon-processor Lambda
            // after the message is created. The Lambda reads the AudioUrl and generates waveform data.
